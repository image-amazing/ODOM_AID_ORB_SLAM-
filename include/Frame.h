...
public:
    ...
    void ComputeOdomPreIntSinceLastFrame(const Frame* pLastF, OdomPreintegrator& odompreint) const;
    ...
    // Odom Data from last Frame to this Frame
    std::vector<OdomData> mvOdomDataSinceLastFrame;

    // For pose optimization, use as prior and prior information(inverse covariance)
    Matrix<double,6,6> mMargCovInv;
